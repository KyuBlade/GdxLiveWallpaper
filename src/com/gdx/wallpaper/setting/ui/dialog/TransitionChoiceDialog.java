...
public class TransitionChoiceDialog extends DialogFragment {

    public static final String TAG = "TransitionChoiceDialog";

    private TransitionType[] items;
    private int selectedIndex;

    public TransitionChoiceDialog() {
        items = TransitionType.values();
    }

    public static TransitionChoiceDialog newInstance() {
        return new TransitionChoiceDialog();
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle(R.string.dialog_playlist_edit_transition_title)
