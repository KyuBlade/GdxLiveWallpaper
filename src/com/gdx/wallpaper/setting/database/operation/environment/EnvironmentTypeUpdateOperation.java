...
public class EnvironmentTypeUpdateOperation implements UpdateOperation<Environment> {

    @Override
    public void provide(Environment object, ContentValues values) {
        values.put(DatabaseHelper.EnvironmentColumns.TYPE, object.getType().ordinal());
    }
}